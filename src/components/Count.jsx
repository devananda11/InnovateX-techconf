export default function Count({ count, time }) {
    return (
      <div className="mx-4 first:ml-0 last:mr-0">
        <div className="relative block min-w-[11rem] p-6 mb-6 text-[6rem] bg-[#2d2d2d] text-green-500 rounded-lg shadow-md overflow-hidden sm:min-w-auto sm:p-4 sm:text-[3rem]">
